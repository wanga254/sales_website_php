...
<body>
	...
	<nav class="navbar">
		<div class="navbar__container">
			<a href="#home" id="navbar__logo">URBAN THRIFT</a>
	...
	<div class="hero" id="home">
		<div class="hero__container">
			<h1 class="hero__heading">Choose Your <span>Look</span></h1>
	...
	<div class="main" id="about">
		<div class="main__container">
			...
			<div class="main__content">
				<h1>What do we do?</h1>
				<h2>We are your one stop shop for everything shopping!</h2>
